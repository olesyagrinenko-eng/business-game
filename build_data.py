...
def main():
    ...
    COMMON_INTRO_ITEMS = [
        ...
        ("У каждого конкурента одинаковое кол-во курьеров, больше курьеров нет, мы можем только переманивать их у конкурента", None),
        ...
        ("Нет никаких штрафных санкций или поощрений за выполнения CTE", 6),  # убрать для раунда 6
