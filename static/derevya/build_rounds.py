...
INTROS = {
    ...
    "5": "Дожди, сурж, сервис доставки, санкции сняты. У нас не бесконечный склад: автоматизированный склад привёз запас под прогноз заказов. Мы продаём скоропортящиеся товары, которые списываются.",
