...
# Индексы колонок xlsx (0-based) — сверьте с заголовками вашего файла.
# В svod_full.txt порядок полей другой: см. build_data.py (там 4=CTE, 5=CPO, 6=DCPO, 7=DC; 10–12=SH, заказы, OPH).
# Ниже — раскладка под export из Excel, где предполагаются SH в [4–6] и CTE в [7] (если у вас как в txt — поменяйте индексы).
